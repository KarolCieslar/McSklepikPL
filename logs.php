            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-md-14">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Wszystkie logi w Twojego sklepu</img></h4>
                                <p class="category">Znajdziesz tutaj ostatnie logi panelu.</p>
                            </div>
                             <div class="content">
                                ...
                                <div style="margin-left:5px;" class="row">
									...
									<?php
											...
											$query="SELECT * FROM `logs` WHERE `licenseID` = '$licenseID' ORDER BY `logs`.`uid` DESC"; 
											$result = mysql_query($query)
											or die("Query failed");
												
											
											echo    ' <table style="border: 0px solid black;" id="example1" class="table table-bordered table-striped table-hover">';
											 echo '<thead style="border: 0px solid black;">';
											...
											while ($row = mysql_fetch_array($result)){
												echo '<tr style="border: 0px solid black;">';
													...
													echo '<td style="border: 0px solid black;"></td>';
												
													if ($row['type'] == "editserver" || $row['type'] == "addserver" || $row['type'] == "deleteserver"){
													  echo '<td style="border: 0px solid black;"><i class="fa fa-circle text-primary"></i><font size="3px">'.$row['date'].' -> '.$row['info'].'</font></td>';
													} elseif ($row['type'] == "addoffer" || $row['type'] == "editoffer" || $row['type'] == "copyoffer" || $row['type'] == "deleteoffer"){
													  echo '<td style="border: 0px solid black;"><i class="fa fa-circle text-warning"></i><font size="3px">'.$row['date'].' -> '.$row['info'].'</font></td>';
													} elseif ($row['type'] == "addvoucher" || $row['type'] == "deletevoucher"){
													  echo '<td style="border: 0px solid black;"><i class="fa fa-circle text-success"></i><font size="3px">'.$row['date'].' -> '.$row['info'].'</font></td>';
													} elseif ($row['type'] == "deletecategory" || $row['type'] == "addcategory"){
													  echo '<td style="border: 0px solid black;"><i class="fa fa-circle text-info"></i><font size="3px">'.$row['date'].' -> '.$row['info'].'</font></td>';
													} elseif ($row['type'] == "deleteuser" || $row['type'] == "newuser" || $row['type'] == "edituser"){
													  echo '<td style="border: 0px solid black;"><i class="fa fa-circle text-secondary"></i><font size="3px">'.$row['date'].' -> '.$row['info'].'</font></td>';
													} 
												 echo '</tr>';
											}
                                ...
                                <div class="footer">
                                    <div class="chart-legend">
                                        ...
                                        <i class="fa fa-circle text-primary"></i> Dotyczące Serwera |
                                        <i class="fa fa-circle text-warning"></i> Dotyczące Oferty |
                                        <i class="fa fa-circle text-success"></i> Dotyczące Vouchera |
                                        <i class="fa fa-circle text-secondary"></i> Dotyczące Użytkowników |
                                        <i class="fa fa-circle text-info"></i> Dotyczące Kategorii
                                    </div>
                                    <hr>
                                    <div class="stats">
                                        <i class="ti-reload"></i> Odświeżane na bierząco...
                                    </div>
                                </div>
                            </div>
                        </div>
